...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    basketcount: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date;
    readingCount: Attribute.Integer;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    favorite_products: Attribute.Relation<
      ...
      'api::favorite-product.favorite-product'
    >;
    sold: Attribute.Integer & Attribute.DefaultTo<0>;
    stock: Attribute.Integer;
    slider: Attribute.Boolean & Attribute.DefaultTo<false>;
    spesifications: Attribute.JSON;
    spesificationsNames: Attribute.JSON;
    variantsNames: Attribute.JSON;
